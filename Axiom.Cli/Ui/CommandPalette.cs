...
internal static class CommandPalette
{
    public static IReadOnlyList<CommandPaletteItem> BuildCore()
    {
        ...
        [
            ...
            new() { Id = "effort-picker", Label = "Kestral 1 effort…", Description = "↑↓ pick low | medium | high | max", Action = "__effort_picker__" },
            new() { Id = "effort-low", Label = "Effort: low", Description = "No reasoning, fastest turns", Action = "/effort low" },
            new() { Id = "effort-medium", Label = "Effort: medium", Description = "Default reasoning/rounds/tokens", Action = "/effort medium" },
            new() { Id = "effort-high", Label = "Effort: high", Description = "More rounds + tokens for thorough work", Action = "/effort high" },
            new() { Id = "effort-max", Label = "Effort: max", Description = "Maximum rounds + tokens", Action = "/effort max" },
